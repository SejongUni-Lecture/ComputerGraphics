...
void MyCube::Quad(int a, int b, int c, int d, glm::vec4 * vin, glm::vec4 * cin)
{
	...
	Vertices[NumCurVertices].position = vin[a]; Vertices[NumCurVertices].color = cin[a]; Vertices[NumCurVertices].normal = n;
	NumCurVertices++;
	Vertices[NumCurVertices].position = vin[b]; Vertices[NumCurVertices].color = cin[b]; Vertices[NumCurVertices].normal = n;
	NumCurVertices++;
	Vertices[NumCurVertices].position = vin[c]; Vertices[NumCurVertices].color = cin[c]; Vertices[NumCurVertices].normal = n;
	NumCurVertices++;
	...
	Vertices[NumCurVertices].position = vin[c]; Vertices[NumCurVertices].color = cin[c]; Vertices[NumCurVertices].normal = n;
	NumCurVertices++;
	Vertices[NumCurVertices].position = vin[d]; Vertices[NumCurVertices].color = cin[d]; Vertices[NumCurVertices].normal = n;
	NumCurVertices++;
	Vertices[NumCurVertices].position = vin[a]; Vertices[NumCurVertices].color = cin[a]; Vertices[NumCurVertices].normal = n;
	NumCurVertices++;
